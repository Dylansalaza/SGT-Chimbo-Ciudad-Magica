...
<div class="w-full flex flex-col">
    ...
    <div class="sticky top-0 z-50 bg-[#00294d] text-white w-full px-10 py-8 shadow-lg border-b border-white/5">
        <div class="w-full flex flex-col sm:flex-row sm:justify-between sm:items-center gap-6">
            ...
            <a href="{{ route('admin.usuarios.create') }}" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-black tracking-wider shadow-md transition-all uppercase self-start sm:self-center">
                        ...
                        <tr class="hover:bg-slate-50/40 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <form method="POST" action="{{ route('admin.usuarios.recovery', $u->id) }}" class="flex items-center gap-1.5">
                                    ...
                                    <input type="email" name="recovery_email" value="{{ $u->recovery_email }}" placeholder="agregar correo…"
                                           class="px-2 py-1 rounded-lg border border-slate-200 text-xs w-48 focus:border-[#00294d] outline-none">
                                    <button type="submit" class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-blue-50 text-blue-600 hover:bg-blue-100 border border-blue-100/70">
                            ...
                            <td class="px-6 py-4 text-center">
                                @if($u->rol === 'administrador')
                                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-black bg-purple-50 text-purple-700 border border-purple-100">
                            ...
                            <td class="px-6 py-4 text-sm text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.usuarios.toggleAdmin', $u->id) }}">
                                        ...
                                        @else
                                            <button type="submit" class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-bold bg-purple-50 text-purple-600 hover:bg-purple-100 border border-purple-100/70 transition">
