                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-slate-50/75 border-b border-gray-100">
                        <tr>
                            ...
                            <th class="px-6 py-3.5 text-[11px] font-black text-slate-500 uppercase tracking-wider">Título de Actividad</th>
                            <th class="px-6 py-3.5 text-[11px] font-black text-slate-500 uppercase tracking-wider">Fecha y Hora Inicio</th>
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        ...
                        <tr class="hover:bg-slate-50/40 transition-colors">
                            <td class="px-6 py-4 text-sm text-slate-400 font-bold text-center">{{ $e->id }}</td>
                            <td class="px-6 py-4 text-sm font-extrabold text-slate-900">{{ $e->title }}</td>
                            <td class="px-6 py-4 text-sm text-slate-600 font-medium">
                                {{ $e->starts_at ? date('d/m/Y H:i', strtotime($e->starts_at)) : '-' }}
                            </td>
